...
class AzkarData extends StatefulWidget {
  const AzkarData({Key? key}) : super(key: key);
...
class _AzkarDataState extends State<AzkarData> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title:
              _textUtils.semiBold("Azkar", whiteColor, 15.0, TextAlign.center),
          centerTitle: true,
        ),
        body: Padding(
            padding:
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          AzkarMOdelDetails azkarDetail = azkarModel[index];
  ...
  Widget duaDtailsData(idText, titalText, index) {
    AzkarMOdelDetails azkarData = azkarModel[index];
    return InkWell(
      onTap: () {
