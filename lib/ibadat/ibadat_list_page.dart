...
import 'package:islamm786/azkar_details/azkar_details.dart';
...
import 'ibadat_model.dart';


class IbadatDataPage extends StatefulWidget {
  const IbadatDataPage({Key? key}) : super(key: key);

  @override
  State<IbadatDataPage> createState() => _IbadatDataPageState();
}

class _IbadatDataPageState extends State<IbadatDataPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title:
          _textUtils.semiBold("Ibadat", whiteColor, 15.0, TextAlign.center),
          centerTitle: true,
        ),
        body: Padding(
            padding:
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      //physics:  NeverScrollableScrollPhysics(),
                        itemCount: ibadatModel.length,
                        itemBuilder: (BuildContext context, int index) {
                          IbadatDataModel azkarDetail = ibadatModel[index];
                          return duaDtailsData(azkarDetail.id.toString(),
                              azkarDetail.title.toString(), index);
                        }),
                  ),
                ],
              ),
  ...
  Widget duaDtailsData(idText, titalText, index) {
    IbadatDataModel azkarData = ibadatModel[index];
    return InkWell(
      onTap: () {
        ...
        child: ListTile(
          ...
          onTap: () {
            Get.to(() => IbadatDetail(
              ...
              textArab: azkarData.textArab,
              textUrdu: azkarData.textUrdu,
              textProof: azkarData.textProof.toString(),
              textArab2: azkarData.textArab2.toString(),
              textUrdu2: azkarData.textUrdu2.toString(),
              textProof2: azkarData.textProof2.toString(),
              textArab3: azkarData.textArab3.toString(),
              textUrdu3: azkarData.textUrdu3.toString(),
              textProof3: azkarData.textProof3.toString(),
              textArab4: azkarData.textArab4.toString(),
              textUrdu4: azkarData.textUrdu4.toString(),
              textProof4: azkarData.textProof4.toString(),
