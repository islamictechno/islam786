...
import 'ibadat_list_page.dart';

class IbadatPage extends StatefulWidget {


  @override
  State<IbadatPage> createState() => _IbadatPageState();
}

class _IbadatPageState extends State<IbadatPage> {
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    const Text("Ibadat",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.white),),
                                    // Spacer(),
                                    Row(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Center(
                                          child:
                                          Text(
                                            "یٰۤاَیُّهَا الَّذِیْنَ اٰمَنُوْا لَا تُلْهِكُمْ اَمْوَالُكُمْ وَ لَاۤ اَوْلَادُكُمْ عَنْ ذِكْرِ اللّٰهِۚ-وَ مَنْ یَّفْعَلْ ذٰلِكَ فَاُولٰٓىٕكَ هُمُ الْخٰسِرُوْنََ",
                                        ...
                                        child: Container(
                                          ...
                                          child: const Row(
                                            ...
                                            children: [
                                              ...
                                              Text("عبادات کے لیے یہاں کلک کریں",style: TextStyle(color: arabicColor,fontSize:14,fontFamily:"Jameelnoori",fontWeight:FontWeight.w700),),
                                              // Icon(Icons.)
                                            ],
                                          ),
                                        ),
