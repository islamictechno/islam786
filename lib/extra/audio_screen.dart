   ...
   // double _width = MediaQuery.of(context).size.width;
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Now Playing',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800),),
      ),
      body: SafeArea(
        child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(fontFamily: "AlQalamQuran", color: Colors.white, fontSize: 18),
                    ),
                  ],
                ),
              ),
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Center(
                          child: Text('UPCOMING SURAH',style: TextStyle(color: arabicColor,
                              fontSize: 18,),),
                        ),
                        SizedBox(height: 5,),
                        Visibility(
                          ...
                          child: Row(
                           ...
                           children: [
                             ...
                             Text(widget.list![currentIndex+1].name!,style: TextStyle(color: arabicColor,fontFamily: "Noorehira",
                                 fontSize: 20),),
                           ],
                       ),
                        ),
                        ...
                        Visibility(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Icon(currentIndex>111 ? null :Icons.play_circle_fill,color: arabicColor),
                              Text(currentIndex>111 ? '' : widget.list![currentIndex+2].name!,style: TextStyle(fontFamily: "Noorehira",color: arabicColor,
                                  fontSize: 20),),
                            ],
                          ),
                        ),
                        SizedBox(height: 5,),
                        Visibility(
                          visible: ( currentIndex <=110) ? true : false,
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Icon(currentIndex>110 ? null :Icons.play_circle_fill,color: arabicColor),
                              Text(currentIndex>110 ? '' : widget.list![currentIndex+3].name!,style: TextStyle(fontFamily: "Noorehira",color: arabicColor,
                                  fontSize: 20),),
                            ],
                          ),
                        ),
                        SizedBox(height: 5,),
                        Visibility(
                          visible: ( currentIndex <=109) ? true : false,
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Icon(currentIndex>109 ? null :Icons.play_circle_fill,color: arabicColor),
                              Text(currentIndex>109 ? '' : widget.list![currentIndex+4].name!,style: TextStyle(fontFamily: "Noorehira",color: arabicColor,
                                  fontSize: 20),),
                            ],
                          ),
                        ),
      ...
      children: [
        SliderTheme(
          data: SliderTheme.of(context).copyWith(
            activeTrackColor: arabicColor,
            inactiveTrackColor: Colors.grey,
            trackHeight: 5.0,
            thumbColor: arabicColor,
            thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10),
            overlayColor: arabicColor,
