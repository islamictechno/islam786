  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          boxShadow: [
            BoxShadow(
              color:arabicColor, offset: Offset(0,1), blurRadius: 10, spreadRadius: 0,
            )
          ],
      ...
      child: Stack(
        ...
        children: [
          ClipRRect(
              borderRadius: BorderRadius.all(Radius.circular(30)),
              child: Image.asset('assets/read_quran_page_header_image.png', color: arabicColor,fit: BoxFit.cover)
          ),
          Positioned.fill(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Image.asset('assets/bismillah_image.png'))
                ],
              ),
            ),
          )
