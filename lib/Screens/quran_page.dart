                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            quranLine(() async {
                              var surahRehman = await PDFDocument.fromAsset(
                                  'assets/pdf/73-surah-al-muzammil.pdf');
                              Get.to(()=>SurahMuzammil(
                                  doc: surahRehman, number: "1"));

                            }, "assets/icons/read.svg", "Surah Muzammil"),

                            quranLine(() async {
                              var documents = await PDFDocument.fromAsset(
                                  'assets/pdf/67-surah-al-mulk.pdf');
                              Get.to(()=>SurahMulak(
                                  doc: documents, number: "0"));
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            quranLine(() async {
                              var surahRehman = await PDFDocument.fromAsset(
                                  'assets/pdf/55-surah-ar-rahman.pdf');
                              Get.to(()=>SurahRehman(
                                  doc: surahRehman, number: "1"));
