...
class SurahRehman extends StatefulWidget {
  final doc;
  final number;

  const SurahRehman({Key? key, this.doc, this.number}) : super(key: key);
  @override
  _SurahRehmanState createState() => _SurahRehmanState();
}

class _SurahRehmanState extends State<SurahRehman> {
