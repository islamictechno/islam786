...
class SurahRehman extends StatelessWidget {
  SurahRehman({Key? key, required this.pdfAssetPath}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Surah Rehman',style: TextStyle(color: Colors.white,fontSize: 17),),
