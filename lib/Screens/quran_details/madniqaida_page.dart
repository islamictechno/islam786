...
class SurahYassen extends StatelessWidget {
  SurahYassen({Key? key, required this.pdfAssetPath}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Surah Yaseen',style: TextStyle(color: Colors.white,fontSize: 17),),
