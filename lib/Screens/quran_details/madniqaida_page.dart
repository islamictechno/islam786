...
class MadniQaidaPage extends StatefulWidget {
  final doc;
  final number;

  const MadniQaidaPage({Key? key, this.doc, this.number}) : super(key: key);
  @override
  _MadniQaidaPageState createState() => _MadniQaidaPageState();
}

class _MadniQaidaPageState extends State<MadniQaidaPage> {
