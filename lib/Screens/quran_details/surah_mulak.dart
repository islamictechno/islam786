...
class SurahMulak extends StatefulWidget {
  final doc;
  final number;

  const SurahMulak({Key? key, this.doc, this.number}) : super(key: key);
  @override
  _SurahMulakState createState() => _SurahMulakState();
}

class _SurahMulakState extends State<SurahMulak> {
