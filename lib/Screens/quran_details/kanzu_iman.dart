...
class Kanzulman extends StatelessWidget {
  Kanzulman({Key? key, required this.pdfAssetPath}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Kanz-ul-Iman',style: TextStyle(color: Colors.white,fontSize: 17),),
