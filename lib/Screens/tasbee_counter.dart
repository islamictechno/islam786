  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.3,
        title: Text("Tasbeeh Counter", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, fontFamily: "Lato"),),
        centerTitle: true,
                ...
                GestureDetector(
                  ...
                  onTap: ()async
                  {
                    await  sound==false?AssetsAudioPlayer.newPlayer().open(
                      Audio("assets/audio/mech-keyboard-02-102918.mp3"),
                      autoStart: true,
